 ...
 * @updateDes ${TODO}
 */
public class Item2RecyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private LayoutInflater mLayoutInflater;
    private Context context;
    private List<LisyBean> list0;
    private int is_show;

    public Item2RecyAdapter(Context context, List<LisyBean> lists, int is_show) {
