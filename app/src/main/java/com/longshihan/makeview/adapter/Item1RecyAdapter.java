 ...
 * @updateDes ${TODO}
 */
public class Item1RecyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private LayoutInflater mLayoutInflater;
    private Context context;
    private List<LisyBean> list0;
    private int is_show;

    public Item1RecyAdapter(Context context, List<LisyBean> lists, int is_show) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.item_1, parent, false);
